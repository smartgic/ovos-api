...
async def sleep(
    ...
    dialog: Optional[Speak] = Body(
        ...
        example='{"utterance": "going to sleep", "lang": "en-us"}')) -> Speak:
    ...
    return JSONResponse(
        status_code=status.HTTP_201_CREATED,
        content=system.sleep(confirm, dialog))
...
async def wake_up(
    ...
    dialog: Optional[Speak] = Body(
        default=None,
        description="Confirmation message to play",
        example='{"utterance": "i am awake", "lang": "en-us"}')) -> Speak:
    ...
    return JSONResponse(
        status_code=status.HTTP_201_CREATED,
        content=system.wake_up(confirm, dialog))
